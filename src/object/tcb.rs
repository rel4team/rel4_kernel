...
//         bufferSlot = 0 as *mut cte_t;
//     } else {
//         dc_ret1 = deriveCap(bufferSlot, &bufferCap);
//         if dc_ret1.status != exception_t::EXCEPTION_NONE {
//             return dc_ret1.status;
//         }
//         bufferCap = dc_ret1.cap.clone();
//         let e = checkValidIPCBuffer(bufferAddr, &bufferCap);
//         if e != exception_t::EXCEPTION_NONE {
//             return e;
//         }
...
//         cap1 = unsafe { updateCapData(false, cRootData, &mut cRootCap).clone() };
//         cRootCap = cap1.clone();
//     }
//     let dc_ret = deriveCap(cRootSlot, &cRootCap).clone();
//     if dc_ret.status != exception_t::EXCEPTION_NONE {
//         return dc_ret.status;
//     }
...
//         vRootCap = unsafe { updateCapData(false, vRootData, &mut vRootCap).clone() };
//     }
//     let dc_ret = deriveCap(vRootSlot, &mut vRootCap).clone();
//     if dc_ret.status != exception_t::EXCEPTION_NONE {
//         return dc_ret.status;
//     }
//     vRootCap = dc_ret.cap.clone();
...
//     println!(
//         "cRootCap :{:#x} {:#x}",
//         cRootCap.words[0], cRootCap.words[1]
//     );
//     println!(
//         "vRootCap :{:#x} {:#x}",
//         vRootCap.words[0], vRootCap.words[1]
//     );
//     println!(
//         "addr :{:#x} {:#x} {:#x} {:#x}",
//         cRootSlot as usize, vRootSlot as usize, bufferAddr as usize, bufferSlot as usize
//     );
//     invokeTCB_ThreadControl(
//         cap_thread_cap_get_capTCBPtr(cap) as *mut tcb_t,
//         slot as *mut cte_t,
