...
impl CNodeCap {
    ...
    #[inline]
    pub fn new( capCNodeRadix: usize, capCNodeGuardSize: usize, capCNodeGuard: usize, capCNodePtr: usize) -> Self {
    ...
    #[inline]
    pub fn set_guard(&mut self, v64: usize) {
        assert!(
    ...
    pub fn get_guard_size(&self) -> usize {
        let mut ret = (self.cap.words[0] & 0x7e0000000000000usize) >> 53;
        /* Possibly sign extend */
        if unlikely(!!(false && (ret & (1usize << (38))) != 0)) {
            ret |= 0x0;
        }
    ...
    #[inline]
    pub fn set_guard_size(&mut self, v64: usize) {
        assert!(
        ...
        self.cap.words[0] &= !0x7e0000000000000usize;
        self.cap.words[0] |= (v64 << 53) & 0x7e0000000000000usize;
    }

    #[inline]
    pub fn get_radix(&self) -> usize {
        let mut ret = (self.cap.words[0] & 0x1f800000000000usize) >> 47;
        /* Possibly sign extend */
        if unlikely(!!(false && (ret & (1usize << (38))) != 0)) {
            ret |= 0x0;
        }
    ...
    pub fn get_ptr(&self) -> usize {
        let mut ret = (self.cap.words[0] & 0x3fffffffffusize) << 1;
        /* Possibly sign extend */
        if (ret & (1 << 38)) != 0 {
